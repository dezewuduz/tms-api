...
public interface ICourseService
{
    ...
    Task<Course?> GetByCodeAsync(string code, CancellationToken ct);
        Task<Course?> GetEntityByIdAsync(int id, CancellationToken ct);          // ← new
    Task<CourseResponseDto?> UpdateAsync(int id, CreateCourseRequest request, CancellationToken ct);
}